...
switch size(X,2)
    ...
    case 2
        try
            ...
            axis('tight');
            xlabel('K', 'FontSize', 16, 'FontName', 'Times', 'Interpreter','latex');
            ylabel('t', 'FontSize', 16, 'FontName', 'Times', 'Interpreter','latex');
            zlabel('\sigma^{imp}', 'FontSize', 16, 'FontName', 'Times', 'Interpreter','latex');
