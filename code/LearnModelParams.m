function model = LearnModelParams(model, data, nlinopt, issimpl, prevHandle, numberOfParameters)

%model = LearnParamsMultistart(model, data, nlinopt, issimpl, prevHandle, numberOfParameters);
